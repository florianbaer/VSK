...
public class LoggerComponent implements Logger {
    ...
    //needs adjustment when implementing LoggerSetup inteface
    ...
    public void debug(String s) {
        printInTerminal(getLogPattern((new Object() {}.getClass().getEnclosingMethod().getName()),s));

    }

    @Override
    public void debug(String s, Throwable throwable) {
        printInTerminal(getLogPattern((new Object() {}.getClass().getEnclosingMethod().getName()),s, throwable));
    }
    ...
    private String getLogPattern(String loggertyp, String message){
        return getCurrentDateAndTime() + " " + loggertyp.toUpperCase() + " " + this.getClass().getSimpleName() + ":" + getLineNumber() + " " + message;
    }
    ...
    private String getLogPattern(String loggertyp, String message, Throwable throwable){
        return getCurrentDateAndTime() + " " + loggertyp.toUpperCase() + " " + this.getClass().getSimpleName() + ":" + getLineNumber() + " " + message + " " + throwable.toString();
    }
